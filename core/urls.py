...
urlpatterns = [
    ...
    path('produtos/<int:pk>/deletar/',
         views.produto_delete, name='produto_delete'),
    ...
    path('fornecedores/<int:pk>/editar/',
         views.fornecedor_edit, name='fornecedor_edit'),
    path('fornecedores/<int:pk>/deletar/',
